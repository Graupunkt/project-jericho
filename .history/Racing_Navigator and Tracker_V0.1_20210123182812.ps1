...
$RaceCheckpoints = [PSCustomObject]@{
    ID = 1
    Planet = "Daymar"
    XCoord = ""
    YCoord = ""
    ...
    $properties = @{
        CheckpointID = $Fritzhost
        CheckpointPlanet = $FritzBoxInfo.NewModelName
        CheckpointXCoord = $FritzBoxWiFi.NewSSID
        CheckpointXCoord = $CurrentPass
        CheckpointXCoord
    }
}
