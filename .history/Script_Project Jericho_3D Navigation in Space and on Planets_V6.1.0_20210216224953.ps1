...
while($StartNavigation) {
    ...
    switch($DistanceGroundVehicles){
        {$_ -lt $Previous_DistanceGroundVehicles} {$VTTendency = ${VTGreen}; $TendecyStatus = "got closer"; break }
        {$_ -gt $Previous_DistanceGroundVehicles} {$VTTendency = ${VTred}; $TendecyStatus = "far away"; break }
        Default {$VTTendency = ${VTDarkGray}; $TendecyStatus = "no change"}
    }
    Write-Host "Distance: $DistanceGroundVehicles km - Tendency: ${VTTendency}wir ENTFERNEN uns${VTDefault}"
