...
while($StartNavigation) {
    ...
    if ($pressed) { 
        ...
        if($script:CurrentDetectedObjectContainer){$line_to_write = "$SystemName;$CurrentDetectedObjectContainer;$PoiName;$CurrentPlanetaryXCoord;$CurrentPlanetaryYCoord;$CurrentPlanetaryZCoord"}
        #IF IN SPACE
