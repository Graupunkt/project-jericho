...
while($StartNavigation) {
    ...
    $ShipRotationValueX1 = [double]$A2 * ([math]::Cos($CurrentCycleAngle/180*[System.Math]::PI)) - [double]$PoiCoordDataY * ([math]::Sin($CurrentCycleAngle/180*[System.Math]::PI))
    $ShipRotationValueY1 = [double]$A2 * ([math]::Sin($CurrentCycleAngle/180*[System.Math]::PI)) + [double]$PoiCoordDataY * ([math]::Cos($CurrentCycleAngle/180*[System.Math]::PI))
    $ShipRotationValueX1
    $ShipRotationValueY1
    $A2
    $B2
