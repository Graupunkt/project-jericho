...
$RaceCheckpoints = @()
    ...
    $RaceCheckpoints += New-Object psobject -Property $properties
#}
$RaceCheckpoints | Select-Object -Property CheckpointID,CheckpointType,CheckpointName,CheckpointPlanet,CheckpointXCoord,CheckpointYCoord,CheckpointZCoord | Out-GridView
