...
while($StartNavigation) {
    ...
    $FinalRevertedXCoord = [double]$RevertedPlanetDataX * ([math]::Cos($CurrentCycleAngle/180*[System.Math]::PI)) - [double]$PoiCoordDataY * ([math]::Sin($CurrentCycleAngle/180*[System.Math]::PI))
