...
while($StartNavigation) {
    ...
    Write-Host -ForegroundColor Cyan "Planet Internal X = $([math]::Truncate($RevertedPlanetDataX/1000).ToString('N0')+"km") - WolfpointX = -4km"
    Write-Host -ForegroundColor Cyan "Planet Internal Y = $([math]::Truncate($RevertedPlanetDataY/1000).ToString('N0')+"km") - WolfpointX = 279km"
    Write-Host -ForegroundColor Cyan "Planet Internal Z = $([math]::Truncate($RevertedPlanetDataZ/1000).ToString('N0')+"km") - WolfpointX = 95km"
    Write-Host -ForegroundColor Red "Site = Wolf Point, X = -4km, Y = 279km, Z = 95km, OM-Radius = 429km, OM3-Wolf = 178km"
