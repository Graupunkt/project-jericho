...
while($StartNavigation) {
    ...
    if($ShipRotationValueY1 -AND $ShipRotationValueY1 -ne $PerviousShipRotationValueX1){$PerviousShipRotationValueY1 = $ShipRotationValueY1}
    if($ShipRotationValuez1 -AND $ShipRotationValueZ1 -ne $PerviousShipRotationValueX1){$PerviousShipRotationValueZ1 = $ShipRotationValueZ1}
    $ScriptLoopCount ++
