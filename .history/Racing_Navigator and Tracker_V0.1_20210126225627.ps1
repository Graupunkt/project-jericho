...
function Create_DynamicFormMainframe{
    ...
    $TrackingIDData.Location = new-object System.Drawing.Point(20,25) 
    $TrackingIDData.size = New-Object System.Drawing.Size(440,20)  
    $TrackingIDData.Text = "enter your trackign id here"
