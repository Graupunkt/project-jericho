...
while($StartNavigation) {
    ...
    [math]::Sin($CurrentCycleAngle*180/[System.Math]::PI) * ($RevertedPlanetDataY / $RevertedPlanetDataY)
    [math]::Cos($CurrentCycleAngle*180/[System.Math]::PI) * ($RevertedPlanetDataY / $RevertedPlanetDataY)
