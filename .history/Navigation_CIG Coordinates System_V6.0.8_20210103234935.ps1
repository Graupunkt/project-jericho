...
foreach ($Tool in $ListOfToolsToStart){
    $3PartyFileName = switch ($tool){
        "ToolAntilogoff" {"Showlocation_Hotkey ALT-R or LEFTCTRL+ALT_RunAsAdmin.exe"}
        "ToolShowLocation" {"Showlocation_Hotkey ALT-R or LEFTCTRL+ALT_RunAsAdmin.exe"}
        "ToolShowOnTop" {"Showlocation_Hotkey ALT-R or LEFTCTRL+ALT_RunAsAdmin.exe"}
        "ToolAutorun" {"Showlocation_Hotkey ALT-R or LEFTCTRL+ALT_RunAsAdmin.exe"}
    }
    Start-process -FilePath "$ScriptDir\Showlocation_Hotkey ALT-R or LEFTCTRL+ALT_RunAsAdmin.exe"
