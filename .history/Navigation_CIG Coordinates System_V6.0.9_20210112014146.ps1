...
while($StartNavigation) {
    ...
    $TriangleGroundA2 = [math]::Sqrt([math]::pow($ShipRotationValueX1,2)) +  - [math]::pow($ShipRotationValueY1,2)) + ([math]::pow($PerviousShipRotationValueZ1,2) - [math]::pow($ShipRotationValueZ1,2))) 
