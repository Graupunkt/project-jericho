...
$QuantummarkerDataGroup = @{
    ...
    "ARC-L1-Station" = "16729134637.3846;-19937006924.8913;8076.625"
    "ARC-L2-Station" = "20446718503.3901;-24367450990.706;8076.625"
    "ARC-L3-Station" = "-25043446883.5029;14458841787.628;8076.625"
    "ARC-L4-Station" = "28478354915.6557;5021502482.91174;8076.625"
    "ARC-L5-Station" = "-9890422516.16967;-27173732225.14;8076.625"
    "CRU-L1-Station" = "-17065957375.9999;-2398463999.99999;0"
    #"CRU-L2" = "0;0;0"
    "CRU-L3-Station" = "18962176000;2664960000;0"
    "CRU-L4-Station" = "-7173168639.99999;-17754204160;0"
    "CRU-L5-Station" = "-11789008988.2602;15089246106.7638;0"
    "MIC-L1-Station" = "20215808582.526974;33466996827.765518;767.452183"
    "HUR-L1-Station" = "11565411328;0;0"
    "HUR-L2-Station" = "14135502848;0;0"
    "HUR-L3-Station" = "-12850457600;-1123.42272949218;0"
    "HUR-L4-Station" = "6425228288;11128823808;0"
    "HUR-L5-Station" = "6425227776;11128823808;0"
    ...
    $LoadButton.Add_Click({
        foreach ($Box in $script:MainForm.Controls){
            foreach ($Checkbox in $Box.Controls){
                ...
                if($Checkbox.Name -like "*Planet - Hurston") {$Checkbox.Checked = $true;$Checkbox.ForeColor  = [System.Drawing.Color]::Green}
            }
        }
    })
