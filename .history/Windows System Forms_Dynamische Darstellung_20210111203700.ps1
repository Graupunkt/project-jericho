...
function Create_DynamicFormMainframe{
    ...
    foreach ($Group in $FinalGroupsForForm){
        ...
        $GroupBox_Drawing_Size.Height = $MainFormVerticalSpace + $OptionHeight * $ListOfGroupOptions
        ...
        $GroupBox_Option_Drawing_Size.Height = $OptionSpacer + $OptionHeight * $ListOfGroupOptions
