...
while($StartNavigation) {
    ...
    #TRIANGLE 1
    $TriangleA = $ShipRotationValueZ1 + $PoiCoordDataZ  # 74km
    $TriangleB = ($DistanceShipToPlanetAlignment/1000) - [double]$PoiCoordDataY # 148km
    $TriangleC = [math]::Sqrt([math]::pow($TriangelA,2) + [math]::pow($TriangleB,2)) # 166km
    $TriangleAlpha = [math]::Sin($TriangleA / $TriangleC) * 180 / [System.Math]::PI
