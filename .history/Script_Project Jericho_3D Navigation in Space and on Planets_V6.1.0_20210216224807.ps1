...
while($StartNavigation) {
    ...
    switch($DistanceGroundVehicles){
        {$_ -lt $Previous_DistanceGroundVehicles} {$VTTendency = ${VTGreen}; $TendecyStatus = "got closer"}
        {$_ -gt $Previous_DistanceGroundVehicles} {$VTTendency = ${VTGreen}; $TendecyStatus = "got closer"}
        Default
    }
    Write-Host "Distance: $DistanceGroundVehicles km - Tendency: ${VTRed}wir ENTFERNEN uns${VTDefault}"

    if ($DistanceGroundVehicles -lt $Previous_DistanceGroundVehicles) {
        Write-Host "Distanz: $DistanceGroundVehicles km - Tendency: ${VTGreen}wir kommen naeher${VTDefault}"
    }
    else {
        Write-Host "Distanz: $DistanceGroundVehicles km - Tendency: ${VTRed}wir ENTFERNEN uns${VTDefault}"
    }
