...
### 3RD PARTY BOX ###
#####################
$3rdParty = New-Object System.Windows.Forms.GroupBox
$3rdParty.Location = New-Object System.Drawing.Size(770,5) 
$3rdParty.size = New-Object System.Drawing.Size(250,120) 
$3rdParty.text = "Limits (meters)" 
$Form.Controls.Add($3rdParty) 
