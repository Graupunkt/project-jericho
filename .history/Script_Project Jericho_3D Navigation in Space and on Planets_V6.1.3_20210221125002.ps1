...
### FUNCTIONS ###
#################
. '.\functions\Calculations and Formulas.ps1'
. '.\functions\Dynamic Forms GUI.ps1'
. '.\functions\Calculations and Formulas.ps1'
. '.\functions\Window settings and controls'
. '.\functions\Calculations and Formulas.ps1'
...
switch($script:CurrentDestination){
    {$PointsOfInterestOnPlanetsData.Name -contains $_} {$script:PlanetaryPoi = $true}
    {$PointsOfInterestInSpaceData.Name -contains $_} {$script:3dSpacePoi = $true}
}
