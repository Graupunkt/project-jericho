...
if ($UseThirdPartyTools){
    ...
    if((get-process "Showlocation_Hotkey ALT-R or LEFTCTRL+ALT_RunAsAdmin" -ea SilentlyContinue) -eq $Null){Start-process -FilePath "$ScriptDir\Autoit Scripts\AntiLogoffScript.exe"}
}
