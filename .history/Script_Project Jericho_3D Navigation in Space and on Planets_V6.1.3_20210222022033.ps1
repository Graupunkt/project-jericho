...
$PoiSpaceCsvPath = "data\Script_Project Jericho_Points of Interest on Planets and ObjectContainers.csv"
...
$PointsOfInterestInSpaceData = Import-Csv -Delimiter ";" $PoiPlanetsCsvPath | Select-Object -Skip 1
...
while($StartNavigation) {
    ...
    if($ShipOMClosest -eq "OM2" -OR $ShipOMClosest -eq "OM1"){                                      
     ...
     Write-Host $FinalHorizontalAngle $FinalVerticalAngle
