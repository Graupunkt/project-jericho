...
$Button.Add_Click({
    ...
    if ($ToolShowLocation.Checked -eq $true){$script:ListOfToolsToStart += "ToolAntilogoff"}
    if ($ToolShowOnTop.Checked    -eq $true){$script:ListOfToolsToStart += "ToolAntilogoff"}
    if ($ToolAutorun.Checked      -eq $true){$script:ListOfToolsToStart += "ToolAntilogoff"}
    $form.Close()
