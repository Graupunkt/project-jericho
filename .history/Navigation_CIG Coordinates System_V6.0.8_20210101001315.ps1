...
while($StartNavigation) {
    ...
    $RevertedPlanetDataX = $RevertedPlanetDataY / 1000
    $RevertedPlanetDataX = $RevertedPlanetDataZ / 1000
    ...
    [math]::Atan($CurrentCycleAngle*180/[System.Math]::PI) * ($RevertedPlanetDataX / $RevertedPlanetDataY)
    [math]::Asin($CurrentCycleAngle*180/[System.Math]::PI) * ($RevertedPlanetDataY / $RevertedPlanetDataX)
    [math]::Atan2($CurrentCycleAngle*180/[System.Math]::PI) * ($RevertedPlanetDataY / $RevertedPlanetDataX)
    ...
    [math]::Tan($CurrentCycleAngle*180/[System.Math]::PI) * ($RevertedPlanetDataX / $RevertedPlanetDataY)
    [math]::Sin($CurrentCycleAngle*180/[System.Math]::PI) * ($RevertedPlanetDataY / $RevertedPlanetDataX)
    [math]::Cos($CurrentCycleAngle*180/[System.Math]::PI) * ($RevertedPlanetDataY / $RevertedPlanetDataX)
    [math]::Tan($CurrentCycleAngle*180/[System.Math]::PI) * ($RevertedPlanetDataY / $RevertedPlanetDataX)

    [math]::Sin($CurrentCycleAngle) * ($RevertedPlanetDataX / $RevertedPlanetDataY)
    [math]::Cos($CurrentCycleAngle) * ($RevertedPlanetDataX / $RevertedPlanetDataY)
    [math]::Tan($CurrentCycleAngle) * ($RevertedPlanetDataX / $RevertedPlanetDataY)
    [math]::Sin($CurrentCycleAngle) * ($RevertedPlanetDataY / $RevertedPlanetDataX)
    [math]::Cos($CurrentCycleAngle) * ($RevertedPlanetDataY / $RevertedPlanetDataX)
    [math]::Tan($CurrentCycleAngle) * ($RevertedPlanetDataY / $RevertedPlanetDataX)

    [math]::Sin($CurrentCycleAngle) * ($RevertedPlanetDataX / $RevertedPlanetDataY)*180/[System.Math]::PI
    [math]::Cos($CurrentCycleAngle) * ($RevertedPlanetDataX / $RevertedPlanetDataY)*180/[System.Math]::PI
    [math]::Tan($CurrentCycleAngle) * ($RevertedPlanetDataX / $RevertedPlanetDataY)*180/[System.Math]::PI
    [math]::Sin($CurrentCycleAngle) * ($RevertedPlanetDataY / $RevertedPlanetDataX)*180/[System.Math]::PI
    [math]::Cos($CurrentCycleAngle) * ($RevertedPlanetDataY / $RevertedPlanetDataX)*180/[System.Math]::PI
    [math]::Tan($CurrentCycleAngle) * ($RevertedPlanetDataY / $RevertedPlanetDataX)*180/[System.Math]::PI
