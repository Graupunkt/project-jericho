...
while($StartNavigation) {
    ...
    $TriangleYC = [math]::Sqrt([math]::pow($TriangelA,2) + [math]::pow($TriangleB,2)) # 166km
    $TriangleYAlpha = [math]::Sin($TriangleA / $TriangleC) * 180 / [System.Math]::PI  # 24,88°

    $TriangleXA = 
    $TriangleXB = $TriangleYB
    $TriangleXC = [math]::Sqrt([math]::pow($TriangleXA,2) + [math]::pow($TriangleB,2))
    $TriangleXAlpha = 
    #$ShipRotationValueX1
    #$PoiCoordDataZ
