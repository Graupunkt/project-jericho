...
$Button.Add_Click({
    ...
    if ($ToolAntilogoff.Checked   -eq $true){$script:CurrentQuantumMarker += "Stanton-Star"}
    if ($ToolShowLocation.Checked -eq $true){}
    if ($ToolShowOnTop.Checked    -eq $true){}
    if ($ToolAutorun.Checked      -eq $true){}
    $form.Close()
