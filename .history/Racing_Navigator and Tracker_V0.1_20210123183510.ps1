...
$RaceCheckpoints = @()
    ...
    $RaceCheckpoints += New-Object psobject -Property $properties
#}
$RaceCheckpoints | Select-Object -Property CheckpointID,CheckpointPlanet,CheckpointName,CheckpointType,CheckpointXCoord,CheckpointYCoord,CheckpointZCoord | Out-GridView
