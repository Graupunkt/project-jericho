...
while($StartNavigation) {
    ...
    [double]$PoiCoordDataY * ([math]::Cos($CurrentCycleAngle/180*[System.Math]::PI)) = -65,91
    279.066 * ([math]::Cos(4.4739)) = 65.91
    279.066 = 65.91 / ([math]::Cos(4.4739)) 
    $x = 65.91 / ([math]::Cos($AngleRadian))
    ...
    [double]$PoiCoordDataY * ([math]::Sin($CurrentCycleAngle/180*[System.Math]::PI))
    $total = -271.17
    $PoiCoordDataX = 279.066
    ...
    $CurrentCycleAngle = 256.34
    $CurrentCycleAngle = 4,4739
