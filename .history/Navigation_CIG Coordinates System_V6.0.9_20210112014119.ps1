...
while($StartNavigation) {
    ...
    $TriangleGroundA1 = [math]::Sqrt([math]::pow($PerviousShipRotationValueX1,2) + [math]::pow($PerviousShipRotationValueY1,2)+ [math]::pow($PerviousShipRotationValueZ1,2))
    $TriangleGroundA2 = [math]::Sqrt(([math]::pow($PerviousShipRotationValueX1,2) - [math]::pow($ShipRotationValueX1,2)) + ([math]::pow($PerviousShipRotationValueY1,2) - [math]::pow($ShipRotationValueY1,2)) + ([math]::pow($PerviousShipRotationValueZ1,2) - [math]::pow($ShipRotationValueZ1,2))) 
    $TriangleGroundB = $CurrentDistanceTotal / 1000
    $TriangleGroundC = [math]::Sqrt([math]::pow($TriangleGroundB,2) - [math]::pow($TriangleGroundA,2))
    $GroundVehicleAlpha = [math]::ASin($TriangleGroundA / $TriangleGroundC) * 180 / [System.Math]::PI 
    Write-Host $TriangleGroundA $TriangleGroundB $TriangleGroundC
