...
while($StartNavigation) {
    ...
    $ShipRotationValueZ1 = $CurrentZPosition / 1000
        ...
        "Current $CurrentDestination X Coord = " + [math]::Round($PoiCoordDataX, 3)
        "Current $CurrentDestination Y Coord = " + [math]::Round($PoiCoordDataY, 3)
        "Current $CurrentDestination Z Coord = " + [math]::Round($PoiCoordDataZ, 3)
        $CurrentDestination
    #}
    ...
    [math]::Tan($DeltaY / $DeltaZ)*180/[System.Math]::PI
    [math]::Sin($DeltaZ / $DeltaY)*180/[System.Math]::PI
    [math]::Cos($DeltaZ / $DeltaY)*180/[System.Math]::PI
    [math]::Tan($DeltaZ / $DeltaY)*180/[System.Math]::PI
    [math]::Sin($DeltaY / $DeltaX)*180/[System.Math]::PI
    [math]::Cos($DeltaY / $DeltaX)*180/[System.Math]::PI
    [math]::Tan($DeltaY / $DeltaX)*180/[System.Math]::PI
    [math]::Sin($DeltaX / $DeltaY)*180/[System.Math]::PI
    [math]::Cos($DeltaX / $DeltaY)*180/[System.Math]::PI
    [math]::Tan($DeltaX / $DeltaY)*180/[System.Math]::PI
