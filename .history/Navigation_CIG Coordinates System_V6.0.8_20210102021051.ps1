...
while($StartNavigation) {
    ...
    #SORT ORBITAL MARKERS BY DISTANCE
    $ShipOmArray = @{}
    $ShipOmArray.add("OM1",$ShipOM1);$OmArray.add("OM2",$ShipOM2);$OmArray.add("OM3",$ShipOM3);$OmArray.add("OM4",$ShipOM4);$OmArray.add("OM5",$ShipOM5);$OmArray.add("OM6",$ShipOM6)

    #GET CLOSEST ORBITAL MARKER
    $OMGSStart = ($ShipOmArray.GetEnumerator() | Sort-Object Value | Select-Object -First 1).Name
    $OMForAngles = ($ShipOmArray.GetEnumerator() | Where-Object {$_.Key -ne "OM1" -AND  $_.Key -ne "OM2"} | Sort-Object Value | Select-Object -First 1).Name
    $OMGSDistanceToDestination = ($ShipOmArray.GetEnumerator() | Sort-Object Value | Select-Object -First 1).Value
