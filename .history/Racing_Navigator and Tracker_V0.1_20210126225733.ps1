...
$RaceCheckpoints = @()
    ...
    $RaceCheckpoints += New-Object psobject -Property $properties
    ...
    $RaceCheckpoints += New-Object psobject -Property $properties
#}
$RaceCheckpoints | Select-Object -Property CheckpointID,CheckpointType,CheckpointName,CheckpointPlanet,CheckpointXCoord,CheckpointYCoord,CheckpointZCoord
...
function Create_DynamicFormMainframe{
    ...
    #$script:MainForm.Text = "Racing Navigator and Tracker"                                                  # Window Title
    ...
    $script:TrackingIDData.Text = "enter your trackign id here"
