...
function Get-StarCitizenClipboardAndDate{
    ...
    $return.ClipboardContainsCoordinates = $ClipboardContainsCoordinates
    $return.CurrentXPosition = $CurrentXPosition
    $return.CurrentYPosition = $CurrentYPosition
    $return.CurrentZPosition = $CurrentZPosition
