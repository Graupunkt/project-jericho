...
function Get-CoordinatesForPoiFromDataArray{
    param ($PointsOfInterestOnPlanetsData, $script:CurrentDestination)
    ...
    return $SelectedDestination,$PoiCoordDataPlanet $PoiCoordDataX, $PoiCoordDataY, $PoiCoordDataZ
}