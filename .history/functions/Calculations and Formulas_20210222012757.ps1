...
function CreateCrosshairOnScreen {
    aram ($InputAngleHorizontal, $InputAngleVertical)
    # Field of View is horizontal pane 
    # vertical pane is about 
    #Example = 115°, Read from Game settings
    #
    $InputAngleHorizontal = 3
    $InputAngleVertical = 
    if ($InputAngleHorizontal -gt 180){$InputAngleHorizontal = 360 - $InputAngleHorizontal}
    $HorizontalViewAngle = 115
    $VerticalViewAngle = 37 * 2 #37° Up and 37° down
