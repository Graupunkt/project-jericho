...
$ShubinMiningFacilitySCD1.Text = "Daymar R0 - Shubin Mining SCD-1" 
...
$EagerFlatsAidShelter.Text = "Daymar R1 - Eager Flats Aid Shelter" 
...
$KudreOre.Text = "Daymar R2 - Kudre Ore" 
