...
while($StartNavigation) {
    ...
    $FinalRevertedXCoord = [double]$RevertedPlanetDataX * ([math]::Cos($CurrentCycleAngle/180*[System.Math]::PI)) - [double]$RevertedPlanetDataY * ([math]::Sin($CurrentCycleAngle/180*[System.Math]::PI))
