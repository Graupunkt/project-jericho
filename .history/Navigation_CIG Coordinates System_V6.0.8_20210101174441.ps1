...
$Button.Add_Click({
    ...
    if ($KudreOreMine.Checked -eq $true)                 {$script:CurrentDestination = "ArcCorp Mining Area 141";$script:PlanetaryPoi = $true}
    if ($KudreOreMine.Checked -eq $true)                 {$script:CurrentDestination = "Dunlow Ridge Aid Shelter";$script:PlanetaryPoi = $true}
