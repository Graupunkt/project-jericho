...
$RaceCheckpoints = @()
    ...
    $RaceCheckpoints += New-Object psobject -Property $properties
#}
$RaceCheckpoints | Select-Object -Property CheckpointID,CheckpointType,CheckpointPlanet,CheckpointName,CheckpointXCoord,CheckpointYCoord,CheckpointZCoord | Out-GridView
