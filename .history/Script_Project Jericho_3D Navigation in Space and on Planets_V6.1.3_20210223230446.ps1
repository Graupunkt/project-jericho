...
while($StartNavigation) {
    ...
    if($script:PlanetaryPoi){
        ...
        $SelectedDestination, $PoiCoordDataPlanet, $PoiCoordDataX, $PoiCoordDataY, $PoiCoordDataZ = Get-CoordinatesForPoiFromDataArray $PointsOfInterestOnPlanetsData, $script:CurrentDestination
