...
while($StartNavigation) {
    ...
    if ($pressed) { 
        ...
        else {$line_to_write = "$SystemName;POI Type;$CurrentDetectedObjectContainer;Type;$PoiName;$CurrentPlanetaryXCoord;$CurrentPlanetaryYCoord;$CurrentPlanetaryZCoord"}
