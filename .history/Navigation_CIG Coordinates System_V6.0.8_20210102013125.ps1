...
while($StartNavigation) {
    ...
    $ClosestQM = $QMDistancesCurrent | Where-Object {$_.QuantumMarkerTo -NotContains $ClosestQMStart.QuantumMarkerTo} | Sort-Object -Property DistanceX | Select-Object -First 1 

    if($OMForAngles -eq "OM3" -OR $OMForAngles -eq "OM4"){                                  # OM on Y-axis
    ...
    if($OMForAngles -eq "OM5" -OR $OMForAngles -eq "OM6"){                                   # OM on X-axis
    ...
    if($OMForAngles -eq "OM1" -OR $OMForAngles -eq "OM2"){                                  # OM on Z-axis
