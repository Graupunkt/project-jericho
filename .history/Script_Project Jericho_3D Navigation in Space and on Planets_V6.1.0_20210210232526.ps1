...
while($StartNavigation) {
    ...
    #OUTPUT COURSE
    Write-Host "COURSE DIAVATION"
    Write-Host "Course Space : ${FAcolor}$("$script:FinalAngle°") ${VTDefault}(Previous: $PreviousAngle °)"
    Write-Host "Course Planet: ${FALcolor}$("$FinalAngleLocal*") ${VTDefault}(Previous: $PreviousAngleLocal °)"
