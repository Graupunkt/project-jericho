...
while($StartNavigation) {
    ...
    $TriangleGroundA = $TriangleGroundA * 100
    $TriangleGroundB = $CurrentDistanceTotal
    ...
    Write-Host "Course Diavation: ${VTGreen}$GroundVehicleAlpha ${VTDefault}(Ground) $TriangleGroundA $TriangleGroundB $TriangleGroundC"
