...
foreach ($Box in $script:MainForm.Controls){
    foreach ($Checkbox in $Box.Controls){
        if($Checkbox.Name -like "*OptionA1"){Write-Host "test A1 successful"}
        if($Checkbox.Name -like "*OptionB1"){Write-Host "test B1 successful"}
        if($Checkbox.Name -like "*OptionC1"){Write-Host "test C1 successful"}
        if($Checkbox.Name -like "*OptionA1"){Write-Host "test A1 successful"}
