...
while($StartNavigation) {
    ...
    #TRIANGLE 1
    if($OMForAngles -eq "OM3" -OR $OMForAngles -eq "OM4")[
        ...
        Write-Host -ForegroundColor Red "Angle for Daymar OM3"
        $TriangleYAlpha
        $TriangleXAlpha
    }


    #$DeltaX = [Math]::Abs($ShipRotationValueX1 - $PoiCoordDataX)
    #$DeltaY = [Math]::Abs($ShipRotationValueY1 - $PoiCoordDataY)
    #$DeltaZ = [Math]::Abs($ShipRotationValueZ1 - $PoiCoordDataZ)

    #$DeltaX
    #$DeltaY
    #$DeltaZ 
    #$DeltaXYZ = [math]::Sqrt([math]::pow($DeltaX,2) + [math]::pow($DeltaY,2) + [math]::pow($DeltaZ,2))
    #$DeltaXY = [math]::Sqrt([math]::pow($DeltaX,2) + [math]::pow($DeltaY,2))
    
    #[math]::Atan(([math]::pow($DeltaZ,2) - [math]::pow($DeltaY,2) + [math]::pow($DeltaXY,2)) / (-2 * $DeltaXY * $DeltaZ))*180/[System.Math]::PI
    #[math]::Sin($DeltaY / $DeltaZ)*180/[System.Math]::PI
    #[math]::Cos($DeltaY / $DeltaZ)*180/[System.Math]::PI
    #[math]::Tan($DeltaY / $DeltaZ)*180/[System.Math]::PI #Eager Flats 36 (36)
    #[math]::Sin($DeltaZ / $DeltaY)*180/[System.Math]::PI #Shubin 21 (21)
    #[math]::Cos($DeltaZ / $DeltaY)*180/[System.Math]::PI
    #[math]::Tan($DeltaZ / $DeltaY)*180/[System.Math]::PI #Shubin 21 (23)
    #[math]::Sin($DeltaY / $DeltaX)*180/[System.Math]::PI #Eager Flats 25 (-25), Shubin 27 (-27)
    #[math]::Cos($DeltaY / $DeltaX)*180/[System.Math]::PI
    #[math]::Tan($DeltaY / $DeltaX)*180/[System.Math]::PI
    #[math]::Sin($DeltaX / $DeltaY)*180/[System.Math]::PI #Shubin 12 (13)
    #[math]::Cos($DeltaX / $DeltaY)*180/[System.Math]::PI
    #[math]::Tan($DeltaX / $DeltaY)*180/[System.Math]::PI #Shubin 12 (13), Eager Flats 22 (-22)
