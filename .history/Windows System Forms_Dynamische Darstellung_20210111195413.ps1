...
function Create_DynamicFormMainframe{
    ...
    $MaxFormSizeHeight = $ScreenResolution[0].WorkingArea.Height       #GET MAX HEIGHT FROM PRIMARY SCREEN, COMPENSATE TASKBAR, ADD VERTICAL SPACE
    ...
    foreach ($Group in $FinalGroupsForForm){
        ...
        $System_Drawing_Size.Width = $OptionWidth
        $System_Drawing_Size.Height = $OptionHeight * $ListOfGroupOptions
