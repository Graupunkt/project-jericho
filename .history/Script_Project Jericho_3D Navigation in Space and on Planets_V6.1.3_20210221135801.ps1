...
switch($Script:CurrentPlayerPosition){
    ...
    #ObjectContainer, if within an objectcontainer and above OM Radius
    #Planet, if 1000m above planet radius or below OM Radius + 10.000m
    #Ground, if 1000m above or below planet radius
}
