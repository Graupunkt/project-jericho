...
$ObjectContainerData = @{                                                                               #if X - offset, raise value
    #PLANETS              X Axis,               Y-Axis,             Z-Axsis,            RotationSpeed,  Rotation Adjustment,    OrbitalMarkerRadius System     InternalName
    Aberdeen            = "12905757636;         40955551;           0;                  2.5999999;      116.69573;              400328;             Stanton"   #Stanton1b
    Arial               = "12892673309;         -31476129;          0;                  5.5100002;      38.39172;               500030;             Stanton"   #Stanton1a
    ArcCorp             = "18587664740;         -22151916920;       0;                  3.1099999;      230.66548;              1144204;            Stanton"   #Stanton3
    Calliope            = "22398369308;         37168840679;        0;                  4.5900002;      212.27548;              352245;             Stanton"   #Stanton4a
    Cellin              = "-18987611119;        -2709009661;        0;                  4.4499998;      253.43259;              380530;             Stanton"   #Stanton2a
    Clio                = "22476728221;         37091020074;        0;                  3.2500000;      311.54775;              489664;             Stanton"   #Stanton4b
    Crusader            = "-18962176000;        -2664959999.99999;  0;                  0;              0;                      11733500;           Stanton"   #Stanton2
    #Daymar             = "-18930539540;        -2610158765;        0;                  2.4800000;      29.86531;               430028;             Stanton"   #Stanton2b #Murphy
    Daymar              = "-18930539540;        -2610158765;        0;                  2.4800000;      30.000000;              430026;             Stanton"   #Stanton2b #Graupunkt
    Euterpe             = "22488109736;         37081123565;        0;                  4.2800002;      268.98801;              314061;             Stanton"   #Stanton4c
    Hurston             = "12850457093;         0;                  0;                  2.4800000;      19.08971;               1427047;            Stanton"   #Stanton1
    Ita                 = "12830194716;         114913609;          0;                  4.8499999;      243.04919;              472454;             Stanton"   #Stanton1d
    Lyria               = "18703607172;         -22121650134;       0;                  6.4299998;      359.31701;              328203;             Stanton"   #Stanton3a
    Magda               = "12792686359;         -74464581;          0;                  1.9400001;      242.31675;              494840;             Stanton"   #Stanton1c
    MicroTech           = "22462016306.0103;    37185625645.8346;   0;                  4.1199999;      217.03922;              1427047;            Stanton"   #Stanton4
    Wala                = "18379649310;         -22000466768;       0;                  6.3200002;      135.44779;              413056;             Stanton"   #Stanton3b
    Yela                = "-19022916799;        -2613996.152;       0;                  1.8200001;      217.57101;              455483;             Stanton"   #Stanton2c
    StantonStar         = "136049870;           1294427.400;        2923345368;         0;              0;                      2500000;            Stanton"   #Stanton
    #REST STOPS
    "ARC-L1-Station"    = "-1946178.84540557;   -3262392.73452758;  3147922.19238728"
    "CRU-L1-Station"    = "-1279569569.42379;   -2246919818.20762;  -4195881979.04336"
    "HUR-L1-Station"    = "-1740752255.43975;   -3262392734.52758;  3147922192.38728"
    "HUR-L2-Station"    = "-3496591017.48466;   5084344726.5625;    2490051995.72071"
    "HUR-L3-Station"    = "3834139855.88029;    -5216795827.29935;  -4718270974.39393"
    "HUR-L4-Station"    = "-1088098630.78594;   2058350356.3404;    1317405788.42163"
    "HUR-L5-Station"    = "-6886053222.65625;   -5700833007.8125;   0448659982.681274"
    "MIC-L1-Station"    = "-1946178845.40557;   -3262392734.52758;  3147922192.38728"
    #LAGRANGE POINTS
    "Lagrange - ARC-L1" = "16729134637.3846;    -19937006924.8913;  8076.625"
    "Lagrange - ARC-L2" = "20446718503.3901;    -24367450990.706;   8076.625"
    "Lagrange - ARC-L3" = "-25043446883.5029;   14458841787.628;    8076.625"
...
while($StartNavigation) {
    ...
    elseif($script:PlanetaryPoi){
        ...
        #$UTCServerTime = [DateTime](Get-Date -Format "dddd, dd MMM yyyy HH:mm:ss.fff").ToUniversalTime() 
    ...
    #DGET CURRENT PLANETARY COORD
    $CurrentXPositionInM = $CurrentXPosition / 1000
    $CurrentYPositionInM = $CurrentYPosition / 1000
    $CurrentZPositionInM = $CurrentZPosition / 1000
    
    $A2 = ($CurrentDetectedOCX - $CurrentXPositionInM)
    $B2 = ($CurrentDetectedOCY - $CurrentYPositionInM)
    $C2 = ($CurrentDetectedOCY - $CurrentZPositionInM)
    ...
    $ShipRotationValueX1 = ([double]$A2 * ([math]::Cos($AngleRadian)) - [double]$B2 * ([math]::Sin($AngleRadian))) * -1
    $ShipRotationValueY1 = ([double]$A2 * ([math]::Sin($AngleRadian)) + [double]$B2 * ([math]::Cos($AngleRadian))) * -1
    $PlanetRotationValueX1 = $ShipRotationValueX1
    $PlanetRotationValueY1 = $ShipRotationValueY1
    $PlanetRotationValueZ1 = $ShipRotationValueZ1


    #DISPLAY CURRENT COORDS OF STANTON, PLANETARY AND POI
    $CurrentPlanetaryXCoord = [math]::Round($PlanetRotationValueX1, 3)
    $CurrentPlanetaryYCoord = [math]::Round($PlanetRotationValueY1, 3)
    ...
    Write-Host "Stanton     : $CurrentXPosition, $CurrentYPosition, $CurrentZPosition"
    if($script:CurrentDetectedObjectContainer){
        Write-Host "Planetary   : $CurrentDetectedObjectContainer = $CurrentPlanetaryXCoord, $CurrentPlanetaryYCoord, $CurrentPlanetaryZCoord"
    }
    else{Write-Host "Planetary   : Space = n/a, n/a, n/a"}
    Write-Host "Destination : $PoiCoordDataPlanet = $CurrentDestinationXCoord , $CurrentDestinationYCoord, $CurrentDestinationZCoord"
    Write-Host ""
    ...
    if($ShipOMClosest -eq "OM5" -OR $ShipOMClosest -eq "OM6"){       
        ...
        Write-Host "Planet: ${VTGreen}$($SelectedPlanet.Name)${VTDefault}, Orbital Marker: ${VTGreen}$ShipOMClosest${VTDefault}, Alignment: ${VTGreen}Planet Centre"
        Write-Host "Alignment Nose: ${VTGreen}Planet Centre${VTDefault}, Wings: ${VTGreen}OM3-4${VTDefault}, Top: ${VTGreen}OM-3"
        Write-Host "Turret Angle: ${VTGreen}$FinalVerticalAngle°${VTDefault} (Vertical)"
        Write-Host "Turret Angle: ${VTGreen}$FinalHorizontalAngle°${VTDefault} (Horizontal)"
    }
