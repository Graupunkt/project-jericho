...
while($StartNavigation) {
    ...
    if($debug){
        ...
        "Current Planet X Coord = " + [math]::Round($PoiCoordDataX, 3)
        "Current Planet Y Coord = " + [math]::Round($PoiCoordDataY, 3)
        "Current Planet Z Coord = " + [math]::Round(($PoiCoordDataZ / 1000), 3)
        $PoiCoordDataX
        "WolfpointX = -4km"
        "WolfpointY = 279km"
        "WolfpointZ = 95km"
