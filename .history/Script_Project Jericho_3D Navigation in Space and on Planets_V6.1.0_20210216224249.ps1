...
while($StartNavigation) {
    ...
    Write-Host "-----------------------"
    $PreviousAngleGroundVehicles = $AngleGroundVehicles
    ...
    $Previous_DistanceGroudnVehicles = $DistanceGroudnVehicles
    $DistanceGroudnVehiclesRAW = CalcDistance3d $CurrentPlanetaryXCoord $CurrentPlanetaryYCoord $CurrentPlanetaryZCoord $PoiCoordDataX $PoiCoordDataY $PoiCoordDataZ
    $DistanceGroudnVehicles = [math]::Pow("$DistanceGroudnVehiclesRAW","2")
    if ($AngleGroundVehicles -le $ausgabe_prev) {
