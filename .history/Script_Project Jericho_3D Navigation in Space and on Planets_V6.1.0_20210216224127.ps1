...
while($StartNavigation) {
    ...
    Write-Host "-----------------------"
    $ausgabe_prev = $AngleGroundVehicles
    $AngleGroundVehicles = CalcEbenenwinkel $PreviousPlanetaryXCoord $PreviousPlanetaryYCoord $PreviousPlanetaryZCoord $CurrentPlanetaryXCoord $CurrentPlanetaryYCoord $CurrentPlanetaryZCoord $PoiCoordDataX $PoiCoordDataY $PoiCoordDataZ
    $AngleGroundVehicles = [math]::Round($AngleGroundVehicles)
