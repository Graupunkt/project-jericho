...
while($StartNavigation) {
    ...
    $CurrentCycleAngle = 176.445498209788
    $CurrentCycleAngle = 180
    ...
    $ShipRotationValueX1 = [double]$A2 * ([math]::Cos($CurrentCycleAngle/180*[System.Math]::PI))  [double]$B2 * ([math]::Sin($CurrentCycleAngle/180*[System.Math]::PI))
    $ShipRotationValueY1 = [double]$A2 * ([math]::Sin($CurrentCycleAngle/180*[System.Math]::PI)) -+ [double]$B2 * ([math]::Cos($CurrentCycleAngle/180*[System.Math]::PI))
    $ShipRotationValueX1
    $ShipRotationValueY1
    $A2
    $B2
