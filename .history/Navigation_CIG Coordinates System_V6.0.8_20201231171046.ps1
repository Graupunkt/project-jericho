...
while($StartNavigation) {
    ...
    Write-Host -ForegroundColor Cyan "Planet Internal Y = $([math]::Truncate($RevertedPlanetDataY/1000).ToString('N0')+"km") - WolfpointX = -4km"
    Write-Host -ForegroundColor Cyan "Planet Internal Z = $([math]::Truncate($RevertedPlanetDataZ/1000).ToString('N0')+"km") - WolfpointX = -4km"
