...
function Create_DynamicFormMainframe{
    ...
    $MainForm_Drawing_Size.Width = $MainFormWidth + $MainFormVerticalBorder
    $MainForm_Drawing_Size.Height = $MainFormHeight + $MainFormOuterBorders + 40
