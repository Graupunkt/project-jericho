...
while($StartNavigation) {
    ...
    $ShipRotationValueX1 = [double]$A2 * ([math]::Cos($AngleRadian)) - [double]$B2 * ([math]::Sin($AngleRadian))
    $ShipRotationValueY1 = [double]$A2 * ([math]::Sin($AngleRadian)) + [double]$B2 * ([math]::Cos($AngleRadian))
    "Current Planet X Coord = " + [math]::Round($ShipRotationValueX1, 3)
    "Current Planet Y Coord = " + [math]::Round($ShipRotationValueY1, 3)
    "Current Planet Z Coord = " + [math]::Round(($CurrentZPosition / 1000), 3)
    "WolfpointX = -4km"
    "WolfpointY = 279km"
    "WolfpointZ = 95km"
