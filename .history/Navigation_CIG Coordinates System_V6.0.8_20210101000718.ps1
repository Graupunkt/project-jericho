...
while($StartNavigation) {
    ...
    [math]::Asin($CurrentCycleAngle*180/[System.Math]::PI) * ($RevertedPlanetDataY / $RevertedPlanetDataY)
    [math]::Atan2($CurrentCycleAngle*180/[System.Math]::PI) * ($RevertedPlanetDataY / $RevertedPlanetDataY)
