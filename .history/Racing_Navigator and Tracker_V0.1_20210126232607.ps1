...
if($script:DaymarRally2950Selected){
    ...
    $DaymarRally2950Checkpoints += New-Object psobject -Property $properties
    if($debug){$DaymarRally2950Checkpoints | Select-Object -Property CheckpointID,CheckpointType,CheckpointName,CheckpointPlanet,CheckpointXCoord,CheckpointYCoord,CheckpointZCoord}
}
