...
while($StartNavigation) {
    ...
    $TriangleGroundA = [math]::Sqrt(([math]::pow($PerviousShipRotationValueX1,2) + ([math]::pow($PerviousShipRotationValueY1,2) [math]::pow($ShipRotationValueY1,2)) + ([math]::pow($PerviousShipRotationValueZ1,2) - [math]::pow($ShipRotationValueZ1,2))) 
