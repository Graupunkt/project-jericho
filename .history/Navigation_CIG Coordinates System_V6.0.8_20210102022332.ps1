...
while($StartNavigation) {
    ...
    #SORT ORBITAL MARKERS BY DISTANCE
    $ShipOmArray = @{}
    $ShipOmArray.add("OM1",$ShipOM1);$ShipOmArray.add("OM2",$ShipOM2);$ShipOmArray.add("OM3",$ShipOM3);$OmArray.add("OM4",$ShipOM4);$OmArray.add("OM5",$ShipOM5);$OmArray.add("OM6",$ShipOM6)
