...
while($StartNavigation) {
    ...
    $ShipOMGSDistanceToDestination = ($ShipOmArray.GetEnumerator() | Sort-Object Value | Select-Object -First 1).Value
    ...
    if($ShipOMForAngles -eq "OM3" -OR $ShipOMForAngles -eq "OM4"){                                  # OM on Y-axis
    ...
    if($ShipOMForAngles -eq "OM5" -OR $ShipOMForAngles -eq "OM6"){                                   # OM on X-axis
    ...
    if($ShipOMForAngles -eq "OM1" -OR $ShipOMForAngles -eq "OM2"){                                  # OM on Z-axis
