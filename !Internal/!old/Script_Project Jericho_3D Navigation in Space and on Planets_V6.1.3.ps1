...
# The first issue could explain all our sketches. May be CIG uses a formula and for example arccorp we have 4.1099999, but if they use a formula it may be 4.1099999999999 (9 period). Over time it adds a detectable amount.
...
while($StartNavigation) {
    ...
    #if($script:3dSpacePoi)  {Write-Host "Destination : $DestinationName `t= $DestCoordDataX;$DestCoordDataY;$DestCoordDataZ"}
    Write-Host ""
