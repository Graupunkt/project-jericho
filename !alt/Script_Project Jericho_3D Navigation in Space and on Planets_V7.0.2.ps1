...
while($StartNavigation) {
    ...
    $OrbitalMarkers = "Current POS : ${VTDarkGray}OM1:${VTDefault}$FinalOM1${VTDarkGray}, OM2:${VTDefault}$FinalOM2${VTDarkGray}, OM3:${VTDefault}$FinalOM3${VTDarkGray}, OM4:${VTDefault}$FinalOM4${VTDarkGray}, OM5:${VTDefault}$FinalOM5${VTDarkGray}, OM6:${VTDefault} $FinalOM6"
    ...
    $OrbitalMarkersD = "Destination : ${VTDarkGray}OM1:${VTDefault}$FinalOM1D${VTDarkGray}, OM2:${VTDefault}$FinalOM2D${VTDarkGray}, OM3:${VTDefault}$FinalOM3D${VTDarkGray}, OM4:${VTDefault}$FinalOM4D${VTDarkGray}, OM5:${VTDefault}$FinalOM5D${VTDarkGray}, OM6:${VTDefault} $FinalOM6D"
    ...
    $Destination = "Destination :".PadRight($SpacingLeftColumns-7),$PoiCoordDataPlanet.PadRight($SpacingLeftColumns-8),$CurrentDestinationXCoord.ToString().PadLeft($SpacingRightColumns-6),$CurrentDestinationYCoord.ToString().PadLeft($SpacingRightColumns),$CurrentDestinationZCoord.ToString().PadLeft($SpacingRightColumns)
