...
while($StartNavigation) {
    ...
    #1st Value is in meters
    #2nd Value is rounded
    ...
    $OmArray = @{}
    $OmArray.add("OM1",$OM1);$OmArray.add("OM2",$OM2);$OmArray.add("OM3",$OM3);$OmArray.add("OM4",$OM4);$OmArray.add("OM5",$OM5);$OmArray.add("OM6",$OM6)
    ($OmArray.GetEnumerator() | Sort-Object Value | Select-Object -First 1).Name
    $OmArray
    #$OrbitalMarkers
    Write-Host -NoNewline "OM1: $OM1"
    Write-Host -NoNewline "OM2: $OM2"
    Write-Host -NoNewline "OM3: $OM3"
    Write-Host -NoNewline "OM4: $OM4"
    Write-Host -NoNewline "OM5: $OM5"
    Write-Host$ "OM6: $OM6"
