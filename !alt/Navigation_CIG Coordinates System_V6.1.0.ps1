...
while($StartNavigation) {
    ...
    if($CurrentXPosition -ne $PreviousXPosition -and $CurrentYPosition -ne $PreviousYPosition -and $CurrentZPosition -ne $PreviousZPosition -and $ClipboardContainsCoordinates){
...
#        $FinalInstructions | Write-Host
    ...
    if ($ButtonDestinationJericho.Checked -eq $true) {
        ...
        $FinalForm.Size = New-Object System.Drawing.Size(900,600)
        ...
        $FinalForm.Controls.Add($dataGridView)
