...
while($StartNavigation) {
    ...
    $WGSSpacing = 17
    $WGS = "Planet/Moon : ".PadRight($WGSSpacing),"${VTDarkgray}Lat: ${VTDefault}$WgsLatitude°".PadRight($WGSSpacing+6),"${VTDarkgray}Long: ${VTDefault}$WgsLongitude°".PadRight($WGSSpacing+14),"${VTDarkgray}Height: ${VTDefault}$WgsHeight"
